# Data Provenance — mamaearth Unified Dataset

Generated: 2026-05-28T21:44:52.668Z
Brand config: memory\mamaearth\brand.config.json

## Source files

| Layer    | File                  | Rows (raw) | Real / Synthesised |
|----------|-----------------------|------------|--------------------|
| Social   | social_data.json      | —          | **Synthesised** — Data for mamaearth. Generated/loaded by pipeline on 2026-05-28T21:44:52.104Z. |
| Sales    | sales_data.json       | —          | **Synthesised** — Data for mamaearth. Generated/loaded by pipeline on 2026-05-28T21:44:52.104Z. |
| Customer | customer_data.json    | —          | **Synthesised** — Data for mamaearth. Generated/loaded by pipeline on 2026-05-28T21:44:52.104Z. |
| Ads      | ads_data.json         | —          | **Synthesised** — Data for mamaearth. Generated/loaded by pipeline on 2026-05-28T21:44:52.104Z. |
...
| Metric                    | Value                  |
|---------------------------|------------------------|
| Total unified records     | 514      |
| Records with all 4 layers | 144 |
| Records with social layer | 514       |
| Records with sales layer  | 175        |
| Records with customer layer | 477   |
| Records with ads layer    | 342          |
